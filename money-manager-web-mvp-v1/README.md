...
- إدارة الديون.
- سجل معاملات قابل للبحث مع تصدير CSV واستيراد كشوف CSV/XLSX.
- رادار للاشتراكات والتجارب المجانية والتنبيهات القادمة.
- مهام إدارية، مواعيد، وسجل للوثائق والإيصالات.
...
- مقارنة شهرية وربع سنوية للتدفق النقدي، مع وضع فاتح/داكن.
